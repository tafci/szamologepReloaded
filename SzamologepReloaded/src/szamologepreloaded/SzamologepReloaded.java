...
public class SzamologepReloaded extends JFrame {
    ...
    JButton operatorGombok[] = new JButton[6];
    private String muveletiJel[] = new String[]{"+", "-", "*", "=", ".", "/"};

    public SzamologepReloaded() {
        initComp();
    ...
    private void initComp() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            szamGombok[i].addActionListener(this::szamAction);
            if (i == 0) {
